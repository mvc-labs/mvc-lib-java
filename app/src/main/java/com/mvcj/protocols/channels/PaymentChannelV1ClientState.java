...
package com.mvcj.protocols.channels;
...
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.AllowUnconfirmedCoinSelector;
...
public class PaymentChannelV1ClientState extends PaymentChannelClientState {
    ...
    public synchronized void initiate(@Nullable KeyParameter userKey) throws ValueOutOfRangeException, InsufficientMoneyException {
        ...
        // relies on the fact that since mvc 0.8 time locked transactions are non-final. This will need to change
