...
public class StoredPaymentChannelServerStates implements WalletExtension {
     ...
     * is measured in terms of our local clock, and the refund transaction's lock time is measured in terms of mvc
     ...
     * This setter will let you delay the setting of the broadcaster until the mvc network is ready.
     *
