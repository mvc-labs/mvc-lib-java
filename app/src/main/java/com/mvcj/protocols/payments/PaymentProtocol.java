...
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.X509Utils;
...
/**
 * <p>Utility methods and constants for working with <a href="https://github.com/mvc/bips/blob/master/bip-0070.mediawiki">
 ...
 * protocol data does not flow over the mvc P2P network or enter the block chain. It's instead for data that is only
