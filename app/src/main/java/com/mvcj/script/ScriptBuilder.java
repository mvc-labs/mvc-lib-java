...
public class ScriptBuilder {
    ...
    public ScriptBuilder data(int index, byte[] data) {
        ...
        } else if (data.length < 65536) { // 2的16
...
//        }
         ...
         else if (data.length < Integer.MAX_VALUE) { //Integer.MAX_VALUE 2的31  最大 4294967296 2的32
            opcode = ScriptOpCodes.OP_PUSHDATA4;
        } else {
            throw new RuntimeException("Unimplemented");
        }
...
//     * @see #number(int)
     ...
     * <a href="https://github.com/mvc/bips/blob/master/bip-0016.mediawiki">BIP 16</a> to learn more about this
     * kind of script.
     */
