...
import com.showpay.showmoneywalletsdk.org.mvcj.core.ProtocolException;
...
import com.showpay.showmoneywalletsdk.org.mvcj.core.UnsafeByteArrayOutputStream;
...
import static com.showpay.showmoneywalletsdk.org.mvcj.script.ScriptOpCodes.*;
 ...
 *
 * <p>mvc transactions don't specify what they do directly. Instead <a href="https://en.mvc.it/wiki/Script">a
...
//    public static final long MAX_SCRIPT_ELEMENT_SIZE = 520;  // bytes
    public static final long MAX_SCRIPT_ELEMENT_SIZE = Integer.MAX_VALUE;  // bytes
    ...
    public byte[] getProgram() {
        try {
            // Don't round-trip as mvc Core doesn't and it would introduce a mismatch.
            if (program != null)
     ...
     * mvc Core does something similar.</p>
     */
     ...
     * The concept of a "from address" isn't well defined in mvc and you should not assume the sender of a
     ...
     * not exist in mvc Core. It means blocks containing P2SH transactions that don't match
    ...
    private static boolean castToBool(byte[] data) {
        ...
        {
            // "Can be negative zero" - mvc Core (see OpenSSL's BN_bn2mpi)
            if (data[i] != 0)
    ...
    // This is more or less a direct translation of the code in mvc Core
    ...
    private static int executeMultiSig(Transaction txContainingThis, int index, Script script, LinkedList<byte[]> stack,
        ...
        // We uselessly remove a stack object to emulate a mvc Core bug.
