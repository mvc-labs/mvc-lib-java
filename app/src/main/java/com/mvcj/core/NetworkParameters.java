...
import com.showpay.showmoneywalletsdk.org.mvcj.params.RegTestParams;
import com.showpay.showmoneywalletsdk.org.mvcj.params.TestNet2Params;
import com.showpay.showmoneywalletsdk.org.mvcj.params.TestNet3Params;
import com.showpay.showmoneywalletsdk.org.mvcj.params.UnitTestParams;
...
import com.showpay.showmoneywalletsdk.org.mvcj.utils.MonetaryFormat;
...
import com.showpay.showmoneywalletsdk.org.mvcj.utils.VersionTally;

/**
 * <p>NetworkParameters contains the data needed for working with an instantiation of a mvc chain.</p>
 *
...
public abstract class NetworkParameters {
    ...
    public static final String ID_MAINNET = "org.mvc.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.mvc.test";
    /** The string returned by getId() for regtest mode. */
    public static final String ID_REGTEST = "org.mvc.regtest";
    /** Unit test network. */
     ...
     *
     * <p>The first block in every chain is a well known constant shared between all mvc implemenetations. For a
     ...
     * test and main mvc networks use 2 weeks (1209600 seconds).
     */
    ...
    /** How many blocks pass between difficulty adjustment periods. mvc standardises this to be 2015. */
    ...
    /**
     * Scheme part for URIs, for example "mvc".
     */
    public abstract String getUriScheme();

    /**
     * Returns whether this network has a maximum number of coins (finite supply) or
     * not. Always returns true for mvc, but exists to be overriden for other
     * networks.
     */
