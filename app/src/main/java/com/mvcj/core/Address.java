...
import com.showpay.showmoneywalletsdk.org.mvcj.params.Networks;
...
/**
 * <p>A mvc address looks like 1MsScoe2fTJoq4ZPdQgqyhgWeoNamYPevy and is derived from an elliptic curve public key
...
public class Address extends VersionedChecksummedBytes {
    ...
    /** The (big endian) 20 byte hash that is the core of a mvc address. */
     ...
     * See also https://github.com/mvc/bips/blob/master/bip-0013.mediawiki: Address Format for pay-to-script-hash
     */
