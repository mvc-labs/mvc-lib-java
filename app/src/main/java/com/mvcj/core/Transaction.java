...
package com.mvcj.core;

import com.google.common.collect.ImmutableMap;
import com.google.common.primitives.Ints;
import com.google.common.primitives.Longs;
import com.showpay.showmoneywalletsdk.org.mvcj.core.TransactionConfidence.ConfidenceType;
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.TransactionSignature;
...
import com.showpay.showmoneywalletsdk.org.mvcj.utils.ExchangeRate;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.Wallet;
 ...
 * the minting of new coins. A Transaction object corresponds to the equivalent in the mvc C++ implementation.</p>
 *
 * <p>Transactions are the fundamental atoms of mvc and have many powerful features. Read
 ...
 *
 * <p>All mvc transactions are at risk of being reversed, though the risk is much less than with traditional payment
...
public class Transaction extends ChildMessage {
    ...
    /**
     * If feePerKb is lower than this, mvc Core will treat it as if there were no fee.
     */
    ...
    public static  int FORKID_VERSION = 2; //Version 2 and above will require the new signature hash

    // These are mvc serialized.
     ...
     * @param payload mvc protocol formatted byte array containing message content.
...
//     * @param parseRetain Whether to retain the backing byte array for quick reserialization.
     ...
     * value is determined by a formula that all implementations of mvc share. In 2011 the value of a coinbase
     ...
     * complete and after every input is added with  and every output is added with
     ...
     * and requires external synchronization. Please refer to general documentation on mvc scripting and contracts
    ...
    public TransactionInput addSignedInputDif(TransactionOutPoint prevOut, Coin utxoValue, Script scriptPubKey, ECKey sigKey,
                                           SigHash sigHash, boolean anyoneCanPay, boolean forkId) throws ScriptException {
        // Verify the API user didn't try to do operations out of order.
        checkState(!outputs.isEmpty(), "Attempting to sign tx without outputs.");
        TransactionInput input = new TransactionInput(params, this, new byte[]{}, prevOut);
        addInput(input);
        Sha256Hash hash = forkId ?
                hashForSignatureWitness(inputs.size() -1, scriptPubKey, utxoValue, sigHash, anyoneCanPay) :
                hashForSignature(inputs.size() - 1, scriptPubKey, sigHash, anyoneCanPay);
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, Coin, Script, ECKey, SigHash, boolean, boolean)}
     * but defaults to {@link SigHash#ALL} and "false" for the anyoneCanPay flag. This is normally what you want.
     */
    ...
    /**
     * Adds an input that points to the given output and contains a valid signature for it, calculated using the
     * signing key.  Assumes forkId is true (sign using mvc Cash Signature)
     */
    ...
    public Sha256Hash hashForSignature(int inputIndex, byte[] connectedScript, byte sigHashType) {
        ...
        //
        //   https://en.mvc.it/wiki/Contracts
        ...
        try {
            ...
            // This step has no purpose beyond being synchronized with mvc Core's bugs. OP_CODESEPARATOR
            // is a legacy holdover from a previous, broken design of executing scripts that shipped in mvc 0.1.
            ...
            // Set the input to the script of its output. mvc Core does this but the step has no obvious purpose as
            ...
            if ((sigHashType & 0x1f) == SigHash.NONE.value) {
                ...
                if (inputIndex >= tx.outputs.size()) {
                    ...
                    // mvc implementation. mvc Core also contains a bug in handling this case:
                    // any transaction output that is signed in this case will result in both the signed output
                    // and any future outputs to this public key being steal-able by anyone who has
                    // the resulting signature and the public key (both of which are part of the signed tx input).

                    // mvc Core's bug is that SignatureHash was supposed to return a hash and on this codepath it
     ...
     * scriptPubKey of the output you're signing for. (See BIP143: https://github.com/mvc/bips/blob/master/bip-0143.mediawiki)</p>
     *
     * @param inputIndex input the signature is being calculated for. Tx signatures are always relative to an input.
     ...
     * since mvc 0.8+ a transaction that did not end its lock period (non final) is considered to be non
     ...
     * <a href="https://github.com/mvc/bips/blob/master/bip-0125.mediawiki">full replace-by-fee </a> semantics.
     */
     ...
     * This is useful in certain types of <a href="http://en.mvc.it/wiki/Contracts">contracts</a>, such as
     * micropayment channels.</p>
     *
     * <p>Note that currently the replacement feature is disabled in mvc Core and will need to be
