...
/**
 * A collection of various utility methods that are helpful for working with the mvc protocol.
 * To enable debug logging from the library, run with -Dbitcoinj.logging=true on your command line.
 */
public class Utils {

    /** The string that prefixes all text messages signed using mvc keys. */
    public static final String BITCOIN_SIGNED_MESSAGE_HEADER = "mvc Signed Message:\n";
     ...
     *
     * <p>mvc only uses this "compact" format for encoding difficulty targets, which are unsigned 256bit quantities.
