...
import static com.showpay.showmoneywalletsdk.org.mvcj.core.Sha256Hash.*;

/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the mvc system.
 ...
 * <a href="http://www.mvc.org/mvc.pdf">the mvc technical paper</a> for
...
public class Block extends Message {
    ...
    static final long ALLOWED_TIME_DRIFT = 2 * 60 * 60; // Same value as mvc Core.

    /**
     * A constant shared by the entire network: how large in bytes a block is allowed to be. One day we may have to
     * upgrade everyone to change this, so mvc can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /**
     * Constructs a block object from the mvc wire format.
    ...
    /**
     * Construct a block object from the mvc wire format.
    ...
    /**
     * Construct a block object from the mvc wire format. Used in the case of a block
     * contained within another message (i.e. for AuxPoW header).
     *
     * @param params NetworkParameters object.
     * @param payloadBytes mvc protocol formatted byte array containing message content.
     * @param offset The location of the first payload byte within the array.
    ...
    /**
     * <p>A utility method that calculates how much new mvc would be created by the block at the given height.
     * The inflation of mvc is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     ...
     * Useful for non-mvc chains where the block header may not be a fixed
     * size.
     */
    ...
    /** Returns the version of the block data structure as defined by the mvc protocol. */
     ...
     * the difficulty value reported by the mvc "getdifficulty" RPC that you may see on various block explorers.
     ...
     * <a href="https://github.com/mvc/bips/blob/master/bip-0034.mediawiki">BIP34: Height in Coinbase</a>.
     */
    ...
    /**
     * Returns whether this block conforms to
     * <a href="https://github.com/mvc/bips/blob/master/bip-0066.mediawiki">BIP66: Strict DER signatures</a>.
     */
    ...
    /**
     * Returns whether this block conforms to
     * <a href="https://github.com/mvc/bips/blob/master/bip-0065.mediawiki">BIP65: OP_CHECKLOCKTIMEVERIFY</a>.
     */
