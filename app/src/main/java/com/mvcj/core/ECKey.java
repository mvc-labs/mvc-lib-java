...
import com.showpay.showmoneywalletsdk.org.mvc.NativeSecp256k1;
import com.showpay.showmoneywalletsdk.org.mvc.NativeSecp256k1Util;
import com.showpay.showmoneywalletsdk.org.mvc.Secp256k1Context;
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.EncryptableItem;
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.EncryptedData;
...
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.LazyECPoint;
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.LinuxSecureRandom;
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.TransactionSignature;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.Protos;
 ...
 *
 * <p>ECKey also provides access to mvc Core compatible text message signing, as accessible via the UI or JSON-RPC.
 ...
 * are encoded using ASN.1/DER inside the mvc protocol.</p>
 *
...
public class ECKey implements EncryptableItem {
    ...
    // The parameters of the secp256k1 curve that mvc uses.
    ...
    /**
     * Construct an ECKey from an ASN.1 encoded private key. These are produced by OpenSSL and stored by mvc
    ...
    /**
     * Output this ECKey as an ASN.1 encoded private key, as understood by OpenSSL or used by mvc Core
     ...
     * how ECDSA signatures are represented when embedded in other data structures in the mvc protocol. The raw
    ...
    public static class ECDSASignature {
         ...
         * href="https://github.com/mvc/bips/blob/master/bip-0062.mediawiki#Low_S_values_in_signatures">BIP62</a>.
         */
         ...
         * the same message. However, we dislike the ability to modify the bits of a mvc transaction after it's
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the mvc protocol, they are
    ...
    /**
     * Signs a text message using the standard mvc messaging signing format and returns the signature as a base64
     * encoded string.
     *
    ...
    /**
     * Given an arbitrary piece of text and a mvc-format message signature encoded in base64, returns an ECKey
     * containing the public key that was used to sign it. This can then be compared to the expected public key to
     * determine if the signature was correct. These sorts of signatures are compatible with the mvc-Qt/bitcoind
     * format generated by signmessage/verifymessage RPCs and GUI menu options. They are intended for humans to verify
     * their communications with each other, hence the base64 format and the fact that the input is text.
     *
     * @param message Some piece of human readable text.
     * @param signatureBase64 The mvc-format message signature in base64
    ...
    /**
     * Exports the private key in the form used by mvc Core's "dumpprivkey" and "importprivkey" commands. Use
