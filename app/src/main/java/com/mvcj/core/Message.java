...
/**
 * <p>A Message is a data structure that can be serialized/deserialized using the mvc serialization format.
...
public abstract class Message {
     ...
     * @param protocolVersion mvc protocol version.
    ...
    // These methods handle the serialization/deserialization using the custom mvc protocol.
    ...
    /**
     * Serialize this message to a byte array that conforms to the mvc wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the mvc wire format.
     *
     * @param stream
     * @throws IOException
     */
