...
import com.showpay.showmoneywalletsdk.org.mvcj.core.listeners.FeeFilterMessage;
import com.showpay.showmoneywalletsdk.org.mvcj.core.listeners.SendHeadersMessage;
...
/**
 * <p>Methods to serialize and de-serialize messages to the mvc network format as defined in
 * <a href="https://en.mvc.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
...
public class BitcoinSerializer extends MessageSerializer {
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A mvc protocol message has the following format.
        //
        ...
        //
        // mvc Core ignores garbage before the magic header bytes. We have to do the same because
