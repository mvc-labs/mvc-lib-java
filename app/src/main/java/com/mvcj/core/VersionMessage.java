...
public class VersionMessage extends Message {
    ...
    /** A service bit used by mvc-ABC to announce mvc Cash nodes. */
    ...
    /**
     * User-Agent as defined in <a href="https://github.com/mvc/bips/blob/master/bip-0014.mediawiki">BIP 14</a>.
     * mvc Core sets it to something like "/Satoshi:0.9.1/".
     */
     ...
     * See <a href="https://github.com/mvc/bips/blob/master/bip-0037.mediawiki#extensions-to-existing-messages">BIP 37</a>.
     */
    ...
    public VersionMessage(NetworkParameters params, int newBestHeight) {
        ...
        // Note that the mvc Core doesn't do anything with these, and finding out your own external IP address
     ...
     *
     * See <a href="https://github.com/mvc/bips/blob/master/bip-0014.mediawiki">BIP 14</a> for more information.
     *
