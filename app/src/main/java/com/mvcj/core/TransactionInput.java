...
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.DefaultRiskAnalysis;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.KeyBag;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.RedeemData;
...
public class TransactionInput extends ChildMessage {
     ...
     * "from address" is not well defined in mvc and you should not assume that senders of a transaction can
     ...
     * in nodes memory pools if the existing version is time locked. See the Contracts page on the mvc wiki for
     ...
     * The "IsStandard" rules control whether the default mvc Core client blocks relay of a tx / refuses to mine it,
