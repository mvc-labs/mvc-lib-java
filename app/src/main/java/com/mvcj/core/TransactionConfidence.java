...
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.CoinSelector;
...
public class TransactionConfidence {
     ...
     * On average there is supposed to be a new block every 10 minutes, but the actual rate may vary. mvc Core
