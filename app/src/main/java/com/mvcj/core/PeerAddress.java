 ...
 * a peer in the mvc P2P network. It exists primarily for serialization purposes.</p>
 * 
...
public class PeerAddress extends ChildMessage {
     ...
     * mvc mainnet, version number is default for the given parameters.
     */
     ...
     * Protocol version is the default for mvc.
     */
