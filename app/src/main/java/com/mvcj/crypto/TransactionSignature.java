...
import com.showpay.showmoneywalletsdk.org.mvcj.core.Transaction.SigHash;
...
public class TransactionSignature extends ECKey.ECDSASignature {
     ...
     * Because mvc Core works via bit testing, we must not lose the exact value when round-tripping
     ...
     * mvc Core. DER and the SIGHASH encoding allow for quite some flexibility in how the same structures
     ...
     * and generally violates people's mental model of how mvc should work, thus, non-canonical signatures are now
     * not relayed by default.
     */
    public static boolean isEncodingCanonical(byte[] signature) {
        // See mvc Core's IsCanonicalSignature, https://bitcointalk.org/index.php?topic=8392.msg127623#msg127623
     ...
     * of the type used by mvc we have to encode them using DER encoding, which is just a way to pack the two
    ...
    public static TransactionSignature decodeFromBitcoin(byte[] bytes,
        ...
        // mvc encoding is DER signature + sighash byte.
        ...
        // In mvc, any value of the final byte is valid, but not necessarily canonical. See javadocs for
