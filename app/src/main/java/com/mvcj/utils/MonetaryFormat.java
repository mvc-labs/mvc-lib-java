...
import com.showpay.showmoneywalletsdk.org.mvcj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /** Currency code for base 1 mvc. */
    public static final String CODE_BTC = "BCH";
    /** Currency code for base 1/1000 mvc. */
    public static final String CODE_MBTC = "mBCH";
    /** Currency code for base 1/1000000 mvc. */
    ...
    private static final String DECIMALS_PADDING = "0000000000000000"; // a few more than necessary for mvc
