...
import com.showpay.showmoneywalletsdk.org.mvcj.utils.BtcAutoFormat.Style;
import static com.showpay.showmoneywalletsdk.org.mvcj.utils.BtcAutoFormat.Style.*;
 ...
 * representations of mvc monetary values.
 *
 ...
 * represents a mvc monetary value.  Some of the features offered for doing this
 * are: <ol>
 ...
 * <code>"฿"</code>.
 *
 * <p>The denomination used when formatting will be either mvc, millicoin
 ...
 * locale, a value of one mvc might be formatted as <pre>฿1.00</pre> where a value
 ...
 * <code>1.0000 BTC</code>, or one mvc, in millibitcoins, one shifts the decimal point
 ...
 * differently the same one-mvc value:
 *
 * <blockquote><pre>
 ...
 * <h3>Formatting</h3>
 *
 * <p>You format a mvc monetary value by passing it to the {@link BtcFormat#format(Object)}
...
public abstract class BtcFormat extends Format {
    ...
    /**
     * Formats a mvc monetary value and returns an {@link AttributedCharacterIterator}.
    ...
    /**
     * Formats a mvc value as a number and possibly a units indicator and appends the
    ...
    /**
     * Formats a mvc value as a number and possibly a units indicator to a
     ...
     * is the size of the decimal-place shift between the given mvc-value denominated in
    ...
    /**
     * Takes a mvc monetary value that the client wants to format and returns the number of
    ...
    /**
     * Takes an object representing a mvc quantity of any type the
    ...
    /**
      * Parse a <code>String</code> representation of a mvc monetary value.  Returns a
    ...
    /** Parse a <code>String</code> representation of a mvc monetary value.  If this
