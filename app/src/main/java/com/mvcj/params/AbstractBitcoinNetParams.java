...
import com.showpay.showmoneywalletsdk.org.mvcj.core.BitcoinSerializer;
...
/**
 * Parameters for mvc-like networks.
 */
public abstract class AbstractBitcoinNetParams extends NetworkParameters {
    /**
     * Scheme part for mvc URIs.
     */
     ...
     */
     BigInteger ComputeTarget(StoredBlock firstBlock,
         ...
         * This code differs from mvc-ABC in that we are using
