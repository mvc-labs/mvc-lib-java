...
import com.showpay.showmoneywalletsdk.org.mvcj.core.ECKey.ECDSASignature;
...
public class DefaultRiskAnalysis implements RiskAnalysis {
     ...
     * different when the fee is about to change in mvc Core.
     */
    ...
    /**
     * <p>Checks if a transaction is considered "standard" by mvc Core's IsStandardTx and AreInputsStandard
     * functions.</p>
     *
