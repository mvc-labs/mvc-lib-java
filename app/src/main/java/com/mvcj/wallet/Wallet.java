...
import com.showpay.showmoneywalletsdk.org.mvcj.core.listeners.NewBestBlockListener;
import com.showpay.showmoneywalletsdk.org.mvcj.core.listeners.ReorganizeListener;
import com.showpay.showmoneywalletsdk.org.mvcj.core.listeners.TransactionConfidenceEventListener;
import com.showpay.showmoneywalletsdk.org.mvcj.core.listeners.TransactionReceivedInBlockListener;
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.ChildNumber;
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.DeterministicHierarchy;
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.DeterministicKey;
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.KeyCrypter;
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.KeyCrypterException;
import com.showpay.showmoneywalletsdk.org.mvcj.crypto.KeyCrypterScrypt;
import com.showpay.showmoneywalletsdk.org.mvcj.script.Script;
import com.showpay.showmoneywalletsdk.org.mvcj.script.ScriptBuilder;
import com.showpay.showmoneywalletsdk.org.mvcj.script.ScriptChunk;
import com.showpay.showmoneywalletsdk.org.mvcj.signers.LocalTransactionSigner;
import com.showpay.showmoneywalletsdk.org.mvcj.signers.MissingSigResolutionSigner;
import com.showpay.showmoneywalletsdk.org.mvcj.signers.TransactionSigner;
import com.showpay.showmoneywalletsdk.org.mvcj.utils.BaseTaggableObject;
import com.showpay.showmoneywalletsdk.org.mvcj.utils.ListenerRegistration;
import com.showpay.showmoneywalletsdk.org.mvcj.utils.Threading;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.listeners.KeyChainEventListener;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.listeners.ScriptsChangeEventListener;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.listeners.WalletChangeEventListener;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.listeners.WalletCoinsReceivedEventListener;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.listeners.WalletCoinsSentEventListener;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.listeners.WalletEventListener;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.listeners.WalletReorganizeEventListener;

import net.jcip.annotations.*;

import com.showpay.showmoneywalletsdk.org.mvcj.core.AbstractBlockChain;
import com.showpay.showmoneywalletsdk.org.mvcj.core.Address;
import com.showpay.showmoneywalletsdk.org.mvcj.core.BlockChain;
import com.showpay.showmoneywalletsdk.org.mvcj.core.BloomFilter;
import com.showpay.showmoneywalletsdk.org.mvcj.core.Coin;
import com.showpay.showmoneywalletsdk.org.mvcj.core.Context;
import com.showpay.showmoneywalletsdk.org.mvcj.core.ECKey;
import com.showpay.showmoneywalletsdk.org.mvcj.core.FilteredBlock;
import com.showpay.showmoneywalletsdk.org.mvcj.core.InsufficientMoneyException;
import com.showpay.showmoneywalletsdk.org.mvcj.core.Message;
import com.showpay.showmoneywalletsdk.org.mvcj.core.NetworkParameters;
import com.showpay.showmoneywalletsdk.org.mvcj.core.Peer;
import com.showpay.showmoneywalletsdk.org.mvcj.core.PeerFilterProvider;
import com.showpay.showmoneywalletsdk.org.mvcj.core.PeerGroup;
import com.showpay.showmoneywalletsdk.org.mvcj.core.ScriptException;
...
import com.showpay.showmoneywalletsdk.org.mvcj.core.TransactionBag;
import com.showpay.showmoneywalletsdk.org.mvcj.core.TransactionBroadcast;
import com.showpay.showmoneywalletsdk.org.mvcj.core.TransactionBroadcaster;
import com.showpay.showmoneywalletsdk.org.mvcj.core.TransactionConfidence;
import com.showpay.showmoneywalletsdk.org.mvcj.core.TransactionInput;
import com.showpay.showmoneywalletsdk.org.mvcj.core.TransactionOutPoint;
import com.showpay.showmoneywalletsdk.org.mvcj.core.TransactionOutput;
import com.showpay.showmoneywalletsdk.org.mvcj.core.UTXO;
import com.showpay.showmoneywalletsdk.org.mvcj.core.UTXOProvider;
import com.showpay.showmoneywalletsdk.org.mvcj.core.UTXOProviderException;
import com.showpay.showmoneywalletsdk.org.mvcj.core.Utils;
import com.showpay.showmoneywalletsdk.org.mvcj.core.VarInt;
import com.showpay.showmoneywalletsdk.org.mvcj.core.VerificationException;
import com.showpay.showmoneywalletsdk.org.mvcj.core.TransactionConfidence.*;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.Protos.Wallet.*;
import com.showpay.showmoneywalletsdk.org.mvcj.wallet.WalletTransaction.*;
...
public class Wallet extends BaseTaggableObject
    ...
    // Dead:     Transactions that we believe will never confirm get moved here, out of pending. Note that mvc
    ...
    private Wallet(Context context, KeyChainGroup keyChainGroup) {
        ...
        confidenceChanged = new LinkedHashMap<Transaction, Listener.ChangeReason>();
    ...
    private void processTxFromBestChain(Transaction tx, boolean forceAddToPool) throws VerificationException {
        ...
        if (isDeadCoinbase) {
            ...
            // we could. mvc Core nodes on the network have deleted the dependent transactions from their mempools
    ...
    /**
     * Returns the amount of mvc ever received via output. <b>This is not the balance!</b> If an output spends from a
    ...
    /**
     * Returns the amount of mvc ever sent via output. If an output is sent to our own wallet, because of change or
    ...
    public static class SendResult {
        /** The mvc transaction message that moves the money. */
     ...
     *
     * @param address The mvc address to send the money to.
     ...
     * @throws ExceededMaxTransactionSize if the resultant transaction is too big for mvc to process.
    ...
    /**
     * Thrown if the resultant transaction is too big for mvc to process. Try breaking up the amounts of value.
     */
            ...
            for (Sha256Hash blockHash : oldBlockHashes) {
                for (TxOffsetPair pair : mapBlockTx.get(blockHash)) {
                    ...
                    if (tx.isCoinBase()) {
                        ...
                        // this coinbase tx. Some can just go pending forever, like the mvc Core. However we
                        // can do our best.
     ...
     * sending transactions to the mvc network by default. Some sendCoins methods let you specify a broadcaster
