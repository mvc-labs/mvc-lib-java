...
import com.showpay.showmoneywalletsdk.org.mvc.protocols.payments.Protos.PaymentDetails;
...
public class SendRequest {
     ...
     * is how mining is incentivized in later years of the mvc system when inflation drops. It also provides
     ...
     * when choosing which transactions to add to a block. Note that, to keep this equivalent to mvc Core
     * definition, a kilobyte is defined as 1000 bytes, not 1024.</p>
     */
    public Coin feePerKb = Context.get().getFeePerKb();

    /**
     * <p>Requires that there be enough fee for a default mvc Core to at least relay the transaction.
